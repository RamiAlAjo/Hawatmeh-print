...
class AdminPagesSliderController extends Controller
{
    /**
...
public function index()
{
    ...
    return view('admin.Pages_Slider.index', compact('sliders')); // Pass to view
}
    ...
    {
        return view('admin.Pages_Slider.create');
    }
    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('pages-slider.index')->with('success', 'Slider image added successfully.');
}
...
public function edit($id)
{
    ...
    if (!$slider) {
        return redirect()->route('pages-slider.index')->with('status-error', 'Slider not found.');
    }

    return view('admin.pages_slider.edit', compact('slider'));
}
...
public function update(Request $request, $id)
{
    ...
    return redirect()->route('pages-slider.index')->with('status-success', 'Slider updated successfully!');
}
...
public function destroy($id)
{
    ...
    return redirect()->route('pages-slider.index')->with('status-success', 'Slider deleted successfully!');
}
