                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-6">
                                <h5 class="card-title pt-2">Video Albums</h5>
                            </div>
                            <div class="col-md-6 col-6 text-right">
                                <a href="{{ route('admin.video-album.create') }}" class="btn btn-primary">Add New</a>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @forelse($albums as $album)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-info" href="{{ route('admin.video-album.edit', $album->id) }}">Edit</a>
                                                        <form action="{{ route('admin.video-album.destroy', $album->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
