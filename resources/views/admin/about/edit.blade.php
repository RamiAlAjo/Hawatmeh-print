                ...
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.about.update', $aboutUs->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')  <!-- This specifies the HTTP method for the update request -->
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="nav-english" role="tabpanel" aria-labelledby="pills-english-tab">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control shadow-sm rounded" name="about_us_description_en" id="about_us_description_en" rows="4">{{ old('about_us_description_en', $aboutUs->about_us_description_en) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control shadow-sm rounded" name="goals_main_title_en" id="goals_main_title_en" value="{{ old('goals_main_title_en', $aboutUs->goals_main_title_en) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control shadow-sm rounded" name="goals_title_en" id="goals_title_en" value="{{ old('goals_title_en', $aboutUs->goals_title_en) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control shadow-sm rounded" name="goals_description_en" id="goals_description_en" rows="4">{{ old('goals_description_en', $aboutUs->goals_description_en) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="services_cards_en">
                                            @foreach($aboutUs->services_card_title_en as $index => $title)
                                                <div class="services-card-input mb-3">
                                                    <input type="text" class="form-control shadow-sm rounded" name="services_card_title_en[]" value="{{ $title }}" placeholder="Service Card Title (English)">
                                                    <textarea class="form-control shadow-sm rounded mt-2" name="services_card_description_en[]" placeholder="Service Card Description (English)" rows="3">{{ $aboutUs->services_card_description_en[$index] }}</textarea>
                                                </div>
                                            @endforeach
                                        </div>
                                ...
                                <div class="tab-pane fade" id="nav-arabic" role="tabpanel" aria-labelledby="pills-arabic-tab">
                                    <div class="text-right" dir="rtl">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control shadow-sm rounded" name="about_us_description_ar" id="about_us_description_ar" rows="4">{{ old('about_us_description_ar', $aboutUs->about_us_description_ar) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control shadow-sm rounded" name="goals_main_title_ar" id="goals_main_title_ar" value="{{ old('goals_main_title_ar', $aboutUs->goals_main_title_ar) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control shadow-sm rounded" name="goals_title_ar" id="goals_title_ar" value="{{ old('goals_title_ar', $aboutUs->goals_title_ar) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control shadow-sm rounded" name="goals_description_ar" id="goals_description_ar" rows="4">{{ old('goals_description_ar', $aboutUs->goals_description_ar) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="services_cards_ar">
                                                @foreach($aboutUs->services_card_title_ar as $index => $title)
                                                    <div class="services-card-input mb-3">
                                                        <input type="text" class="form-control shadow-sm rounded" name="services_card_title_ar[]" value="{{ $title }}" placeholder="عنوان الخدمة (Arabic)">
                                                        <textarea class="form-control shadow-sm rounded mt-2" name="services_card_description_ar[]" placeholder="وصف الخدمة (Arabic)" rows="3">{{ $aboutUs->services_card_description_ar[$index] }}</textarea>
                                                    </div>
                                                @endforeach
                                            </div>
...
<script>
    ...
    let serviceCardCountEn = {{ count($aboutUs->services_card_title_en) }};
    ...
    let serviceCardCountAr = {{ count($aboutUs->services_card_title_ar) }};
