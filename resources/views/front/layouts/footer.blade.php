    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-4 text-center col-FO-custom">
                <img src="./Rectangle.svg" alt="Hawatmeh Logo" width="150" style="margin-right: 15%; height: 200px; width: 200px;">
            </div>
            ...
            <div class="col-md-4 text-center col-FO-custom">
                ...
                <div class="social-FO-icons">
                    ...
                    <a href="#">
                        <img src="{{ asset('assets/icons/fb.svg') }}" alt="Facebook" />
                    </a>
                    <a href="#">
                        <img src="{{ asset('assets/icons/insta.svg') }}" alt="Instagram" />
                    </a>
                </div>
